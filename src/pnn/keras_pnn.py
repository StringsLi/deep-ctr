# -*- coding: utf-8 -*-
"""
Created on Mon Sep 30 17:03:16 2019

@author: lixin
"""
import pandas as pd
import numpy as np
from keras.layers import Dense, Input, Flatten, Embedding, concatenate, dot
...
if __name__ == '__main__':
    ...
    pnn = PnnModel(embedding_list, 5, X_train, y_train, X_test, y_test)
    
    batch_size, epochs = 64, 10
    
    pnn.train(batch_size, epochs)
    
    pred = pnn.predict(batch_size)
